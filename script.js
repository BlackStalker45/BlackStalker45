...
const data = {
    ...
    "words_medium": ["ABSTRACT", "BALANCED", "CREATIVE", "DISCOVER", 
                  ...
                  "NAVIGATE", "OPTIMIZE", "PARADISE", "RESOURCE", 
				  "SCULPTOR", "TRANQUIL", "UNIVERSE", "VOYAGING", 
				  "WHISPERS", "ABSOLUTE", "CATALYST", "DIRECTLY", 
				  "EXERTION", "FOUNTAIN", "GRADIENT", "INNOVATE",
                  "MONETARY", "OVERFLOW", "PRESENCE", "QUARTILE", 
				  "VORTEXER", "GRAVITON", "BLOODSUK", "MERCENAR", 
				  "MONOLITH", "RENEGADE", "CLEARSKY", "MILITARY", 
				  "STALKERS", "GAUSSRIF", "VINTOREZ", "ARTIFACT", 
				  "DETECTOR", "SILENCER", "YANTARNY", "DARKSONE", 
				  "CNPPZONE", "RADSTORM", "EMISSION", "STASHBOX", 
				  "WISHGRAN", "DEADSOUL", "STALKING", "RUSTLAND", 
				  "ZONERULE", "ARTIFACT", "SECRETST", "GALACTIC", 
				  "MOLECULE", "OBSIDIAN", "SOFTWARE", "HARDWARE", 
				  "ROBOTICS", "NANOTECH", "KEYBOARD", "LASERDOT", 
				  "HOLOGRAM", "EUPHORIA", "SERENITY", "PARANOIA", 
				  "BLISSFUL", "TOKYOITE", "PARISIAN", "TROPICAL", 
				  "ATLANTIC", "HIGHLAND", "WIZARDRY", "WEREWOLF", 
				  "ELVENBOW", "MYSTICAL", "CHOCOLAT", "ESPRESSO", 
				  "MACARONI", "CINNAMON", "MARGARIT", "BARBECUE", 
				  "SYMPHONY", "BALLROOM", "CALLIGRA", "GRAFFITI", 
				  "BASKETRY", "FOOTBALL", "YOGALIFE", "SKATEPAD", 
				  "MARATHON", "ENGINEER", "DESIGNER", "CURIOSIT", 
				  "ILLUSION", "INFINITY", "VELOCITY", "ETERNITY"],
    "words_hard": ["ABSTINENCE", "DELIBERATE", "EFFICIENCY", "FREELANCER", 
				 "GENEROSITY", "HARMONIOUS", "IMPRESSIVE", "JUXTAPOSED", 
				 "LUMINOSITY", "MEDITATION", "NEGOTIATOR", "PERFECTION", 
				 "QUALIFIERS", "REVELATION", "VIBRATIONS", "XENOPHOBIA", 
				 "YEARNINGLY", "ACCELERATE", "INNOVATION", "JUBILATION", 
                 "NAVIGATING", "GRAVITWAVE", "VORTEXHOLE", "RADIATIONR", 
				 "WARPEDSPAC", "PHANTOMLIT", "CHIMERABEA", "BLOODSUCKR", 
				 "POLTERGEIS", "SNORKWALKR", "BURERNESTE", "FLESHMONST",
				 "CONTROLLER", "HOWLERPACK", "ZOMBIEHORD", "DUTYFIGHTR", 
				 "FREEDOMITE", "MERCENARYS", "MONOLITHIA", "RENEGADETE", 
				 "CLEARSKYER", "MILITARYMN", "ECOLOGISTI", "BANDITKING", 
				 "GAUSSRIFLE", "VINTOREZGN", "EXOSKELETO", "ARTIFACTBG", 
				 "BULLETPROF", "ARMOREDSUI", "GASMASKFAC", "DETECTORBX", 
				 "SILENCERGN", "GRENADEPAC", "PRIPYATCIT", "ROSTOKBASE", 
				 "YANTARZONE", "DARKSVALLE", "GARBAGEDMP", "SWAMPSAREA", 
				 "LIMANSKOLD", "JUPITERPLN", "CNPPCENTER", "RADSTORMER", 
				 "ANOMALYPIT", "EMISSIONHT", "PSYWAVEPUL", "BLEEDINGOT", 
				 "STASHHIDDN", "HAZARDZONE", "WOUNDEDMAN", "SHELTERCMP", 
				 "WISHGRANTR", "GHOSTLYMAN", "VOICESHEAD", "SHADOWBEAS", 
				 "XLABSECRET", "STALKINGMN", "LOOTINGBAG", "HUNTINGPRE", 
				 "HIDINGSPOT", "SHOOTERAIM", "RUNAWAYMAN", "BARTERDEAL", 
				 "TRADINGPST", "UPGRADEPRT", "RUSTYPLACE", "DECAYEDZON", 
				 "RUINEDCITY", "RADMONSTER", "FEARFULMAN", "JOURNEYING" ]
};
